  ...
  questForm.addEventListener("submit", (e) => {
    ...
    if (questType === "specific") {
      ...
      const selectedUserText =
        specificUsers.options[specificUsers.selectedIndex].text;
    ...
    if (currentEditCard) {
      ...
      currentEditCard.querySelectorAll(".stat-value")[0].innerText =
        `+${exp} 🌟`;
